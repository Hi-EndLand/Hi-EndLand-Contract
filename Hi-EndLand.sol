...
contract HiEndLand is ERC20, Ownable {
    uint256 public buyFee = 2;
    uint256 public sellFee = 2;

    address public marketingWallet = 0xE78afbd435Dfcd1AAB851f8ac02a295C2B4ad7F0;
    ...
    constructor () ERC20("Hi-EndLand", "HEL") 
    {   
    ...
    function updateFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 10 && _sellFee <= 15, "Buy fee cannot be more than 10% and sell fee cannot be more than 15%");
        buyFee = _buyFee;
        sellFee = _sellFee;
